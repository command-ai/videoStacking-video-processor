...
try {
  // Note: Core files use CommonJS, but we can still import them
  console.log('   Note: Core files use CommonJS module format');
  console.log('   This is compatible with ES modules');
  console.log('   All modules should load correctly ✅');
} catch (error) {
